...
CREATE OR REPLACE API INTEGRATION git_api_integration
  ...
  API_ALLOWED_PREFIXES = ('https://github.com/sfc-gh-aabouhadid') -- INSERT YOUR GITHUB USERNAME HERE
  ENABLED = TRUE;
...
CREATE OR REPLACE GIT REPOSITORY quickstart_common.public.quickstart_repo
  ...
  ORIGIN = 'https://github.com/sfc-gh-aabouhadid/snowflake-devops.git'; -- INSERT URL OF FORKED REPO HERE
